...
Per-object parameter/growth/seed-redshift panels & 657 \\
\bottomrule
\end{tabular}
\end{table}
...
gallery. Every one of the 219 objects has a parameter-map panel, growth-track
panel, and seed-redshift panel under the final gallery path. For the 23
unavailable objects these are
explicit no-inference panels. Complete parameter-map, compatibility, and Monte
Carlo atlas figures preserve every object label for close zooming.
