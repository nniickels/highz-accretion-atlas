...
inference. The measurement--object link table records each decision and reason. The final completion illustrates this policy: 15 NEXUS
...
all 227 primary objects use Balmer-line single-epoch virial masses. Of the ten
...
\caption{Exploratory-sample uncertainty summary for 225 objects with reported mass errors
...
\caption{Exploratory-sample descriptive compatibility across seed families, spin/efficiency cases,
...
Final object counts require the identity work specified in
