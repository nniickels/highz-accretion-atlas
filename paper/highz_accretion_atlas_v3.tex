...
JWST spectroscopy and photometry, together with supporting X-ray observations,
have revealed diverse accreting black-hole candidates at high redshift.
The atlas covers $z\geq4$, extending from the first billion years to a cosmic
age of approximately 1.54 Gyr at its lower-redshift boundary. Their inferred masses and early observation times constrain how
...
ages and growth intervals are expressed in Gyr. These are the atlas's adopted
parameters, not a fit to this catalogue. We define $\fedd=L_{\rm bol}/L_{\rm Edd}$
and use $t_{\rm Edd}=c\sigma_T/(4\pi Gm_p)\simeq0.45$ Gyr.
...
Eddington ratio. For fixed efficiency, the exponent depends on the time integral of $\fedd$;
its average includes inactive intervals. It does not establish a duty cycle.
A single merger factor and fixed efficiency do not resolve feedback cycles,
changing accretion states, or stochastic mergers. We therefore call the derived quantity \emph{growth
...
0.038, 0.057, and 0.423 for dimensionless spin $a=-1,0,+1$
\cite{bardeen1972}. These are ideal zero-torque ISCO binding efficiencies,
neglecting photon capture. Above unity they use
\begin{equation}
\epsilon_{\rm eff}=\epsilon_a\fedd\exp(1-\fedd).
\end{equation}
This follows algebraically from the adopted phenomenological luminosity ansatz
...
record SHA-256 hashes for 85 v1, 461 v2, and 723 v3 artifacts. Verification
...
result inventory contains 1,239 artifacts.
