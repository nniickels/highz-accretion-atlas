...
Figure~\ref{fig:landscape} shows the broader numerical sample alongside records
without masses. Its coverage panel explains why evidence-catalogue size exceeds
the number of growth constraints; it is not the selection diagram for the
224-object manuscript primary sample. All five figures retain the frozen
catalogue scope, including the excluded records, for context. Numerical claims
in the text and Tables~\ref{tab:top}--\ref{tab:scenarios} use the exclusion
samples unless explicitly identified as catalogue sensitivity comparisons.
...
to show the mass and time scales. It is a contextual comparison, not a fit to
individual histories or a visualization restricted to the primary sample.
...
\caption{Full-catalogue exploratory uncertainty summary for 225 objects with reported mass errors
...
Figure~\ref{fig:compatibility} shows the full exploratory scenario grid by
admitted class. Its dependence on spin/efficiency, merger boost, and seed
...
\caption{Full-catalogue exploratory descriptive compatibility across seed families, spin/efficiency cases,
...
\caption{Seven alternate-measurement comparisons across six objects. Numbered points
