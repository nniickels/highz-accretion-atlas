...
method tags, URLs, archive checksums, and identity decisions are preserved.
...
\begin{figure}[p]
\centering
\includegraphics[width=0.99\textwidth]{../results/releases/v7_5/figures/main_text/v7_5_catalogue_growth_landscape.png}
...
\begin{figure}[p]
\centering
\includegraphics[width=0.99\textwidth]{../results/releases/v7_5/figures/main_text/v7_5_class_aware_growth_pressure.png}
...
\begin{figure}[p]
\centering
\includegraphics[width=0.97\textwidth]{../results/releases/v7_5/figures/main_text/v7_5_uncertainty_robustness.png}
...
\begin{figure}[p]
\centering
\includegraphics[width=0.99\textwidth]{../results/releases/v7_5/figures/main_text/v7_5_measurement_sensitivity.png}
...
\bibitem{zou2026} Zou, F. et al. 2026, UHZ1 full-data X-ray reanalysis, source version recorded in the v7.3 evidence-history table.
