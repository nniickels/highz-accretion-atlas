"""Regression checks for the expanded BLAGN science workflow."""
...
from src.expanded_catalogue import TAYLOR_SOURCE_KEY
from src.expanded_science import EPSILON, MERGER_BOOST, Z_SEED


RESULTS = REPO_ROOT / "results"


class ExpandedScienceOutputTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls) -> None:
        names = {
            "measurement_eval": "expanded_blagn_measurement_evaluation.csv",
            "object_eval": "expanded_blagn_physical_object_evaluation.csv",
            "measurement_point": "expanded_blagn_measurement_point_ranking.csv",
            "object_point": "expanded_blagn_physical_object_point_ranking.csv",
            "measurement_fedd": "expanded_blagn_measurement_uncertainty_fedd.csv",
            "measurement_mseed": "expanded_blagn_measurement_uncertainty_mseed.csv",
            "object_fedd": "expanded_blagn_physical_object_uncertainty_fedd.csv",
            "object_mseed": "expanded_blagn_physical_object_uncertainty_mseed.csv",
            "measurement_uncertainty": "expanded_blagn_measurement_uncertainty_ranking.csv",
            "object_uncertainty": "expanded_blagn_physical_object_uncertainty_ranking.csv",
            "catalogue_summary": "expanded_blagn_catalogue_summary.csv",
            "growth_summary": "expanded_blagn_growth_summary.csv",
        }
    ...
    def test_v1_baseline_growth_metrics_are_preserved(self) -> None:
        ...
        v1 = pd.read_csv(RESULTS / "v1_object_ranking_table.csv").set_index("measurement_id")
        columns = [
