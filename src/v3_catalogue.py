"""Build the v3 BLAGN catalogue without mutating the v1 or v2 releases.
...
def build_v3_catalogues(
    v1_processed: pd.DataFrame,
    taylor_raw: pd.DataFrame,
    links: pd.DataFrame,
) -> tuple[pd.DataFrame, pd.DataFrame]:
    """Return measurement- and physical-object-level v3 catalogue views."""
    ...
    measurements["catalogue_release"] = "v3-blagn"
