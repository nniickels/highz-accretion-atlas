"""Build the immutable catalogue-only v7 UHZ1 evidence-history extension."""
...
from src.internal.compatibility.v7_uhz1 import (
...
def build_v7_uhz1_catalogues(
    ...
    """Append the two UHZ1 evidence assessments within the v7 build."""
    new = build_uhz1_admission(
        uhz1_history, miri_table3, template_columns=list(v7_measurements.columns),
    )
