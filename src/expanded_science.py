"""Science evaluation and triage rankings for the expanded BLAGN catalogue.

This module deliberately does not read or write v1 artifacts.  It operates on
the separate expanded measurement and preferred-physical-object catalogue
...
from scripts.generate_v1_uncertainty_rankings import (
...
CATALOGUE_RELEASE = "expanded-blagn-v1"
Z_SEED = 30.0
EPSILON = 0.1
MERGER_BOOST = 1.0
...
def verify_expanded_outputs(outputs: dict[str, pd.DataFrame], *, n_samples: int) -> dict[str, bool]:
