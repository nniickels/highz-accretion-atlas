"""Class-aware growth diagnostics for the frozen v7.2 catalogue.
...
from src.v7_admission import validate_v7_admission


SCIENCE_RELEASE = "v7.2-class-aware-science"
Z_SEED = 30.0
EPSILON = 0.1
MERGER_BOOST = 1.0
...
def verify_science_outputs(outputs: dict[str, pd.DataFrame], *, n_samples: int) -> None:
    ...
    if not all(checks.values()):
        ...
        raise ValueError(f"v7.2 class-aware science verification failed: {failed}")
