...
`processed/v3/v3_accreting_objects.csv` (338 physical objects). Use
`v3_accreting_measurements.csv` for all 350 literature measurements. The
catalogue contains 337 host systems; source-observable, strata, and identity
...
JWST-identified heterogeneous comparison and candidate sources (350 / 338).
