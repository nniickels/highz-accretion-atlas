...
`processed/v3/v3_accreting_objects.csv` (219 physical objects). Use
`v3_accreting_measurements.csv` for all 234 literature measurements. Host,
...
the heterogeneous comparison/candidate sources (234 / 219).
