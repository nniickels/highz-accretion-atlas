...
| --- | --- | --- |
| 320 measurements / 311 objects / 310 hosts | v3 dataset manifest and verifier | verified |
...
| 219 eligible measurements / 212 eligible objects | v3 dataset manifest and exact science reproduction | verified |
| 99 catalogue-only objects | v3 gallery coverage verifier | verified |
| 209/202 primary measurement/object rows | focused claim regression, canonical catalogue tables, and reproduction gate | verified |
| 7 alternate-measurement comparisons | focused claim regression, canonical science table, and reproduction gate | verified |
| Follow-up matrix contains 311 objects: 212 ranked and 99 explicitly unranked | canonical follow-up table and verifier | verified |
| Source-caveat summary contains one row for each of 29 admitted source families | canonical caveat table and verifier | verified |
...
| 622 per-object panels cover all 311 objects: 311 $f_{Edd}$-mass and 311 seed-redshift-mass panels | focused claim regression, v3 dataset manifest, and visual-coverage verifier | verified |
...
The manuscript cites all 29 admitted source families:
...
Dayal for the growth model. The manuscript's 33 citation keys and 33
