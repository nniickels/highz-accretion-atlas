"""Generate expanded BLAGN evaluation, ranking, uncertainty, and summary CSVs."""
...
from src.expanded_science import (
    DEFAULT_N_SAMPLES,
    DEFAULT_RANDOM_SEED,
    ...
    verify_expanded_outputs,
)


PROJECT_ROOT = Path(__file__).resolve().parents[1]
RESULTS_DIR = PROJECT_ROOT / "results"
MEASUREMENT_INPUT = PROJECT_ROOT / "data" / "processed" / "expanded_blagn_measurements.csv"
OBJECT_INPUT = PROJECT_ROOT / "data" / "processed" / "expanded_blagn_objects.csv"

OUTPUT_PATHS = {
    "measurement_evaluation": RESULTS_DIR / "expanded_blagn_measurement_evaluation.csv",
    "object_evaluation": RESULTS_DIR / "expanded_blagn_physical_object_evaluation.csv",
    "measurement_point_ranking": RESULTS_DIR / "expanded_blagn_measurement_point_ranking.csv",
    "object_point_ranking": RESULTS_DIR / "expanded_blagn_physical_object_point_ranking.csv",
    "measurement_uncertainty_fedd": RESULTS_DIR / "expanded_blagn_measurement_uncertainty_fedd.csv",
    "measurement_uncertainty_mseed": RESULTS_DIR / "expanded_blagn_measurement_uncertainty_mseed.csv",
    "object_uncertainty_fedd": RESULTS_DIR / "expanded_blagn_physical_object_uncertainty_fedd.csv",
    "object_uncertainty_mseed": RESULTS_DIR / "expanded_blagn_physical_object_uncertainty_mseed.csv",
    "measurement_uncertainty_ranking": RESULTS_DIR / "expanded_blagn_measurement_uncertainty_ranking.csv",
    "object_uncertainty_ranking": RESULTS_DIR / "expanded_blagn_physical_object_uncertainty_ranking.csv",
    "catalogue_summary": RESULTS_DIR / "expanded_blagn_catalogue_summary.csv",
    "growth_summary": RESULTS_DIR / "expanded_blagn_growth_summary.csv",
}
...
def main() -> None:
    ...
    checks = verify_expanded_outputs(outputs, n_samples=args.n_samples)
