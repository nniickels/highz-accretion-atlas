"""Generate the non-breaking CEERS/RUBIES-expanded BLAGN catalogue release."""
...
from src.expanded_catalogue import build_expanded_catalogues, validate_taylor_raw
...
LINK_PATH = PROJECT_ROOT / "data" / "crossmatch" / "measurement_object_links.csv"
MEASUREMENT_OUTPUT_PATH = PROJECT_ROOT / "data" / "processed" / "expanded_blagn_measurements.csv"
OBJECT_OUTPUT_PATH = PROJECT_ROOT / "data" / "processed" / "expanded_blagn_objects.csv"
...
def main() -> None:
    ...
    measurements, objects = build_expanded_catalogues(v1, validated_taylor, links)
