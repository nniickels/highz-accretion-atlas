...
def verify_gallery_contract() -> None:
    ...
    if len(results_inventory) != 269 or not results_inventory["path"].is_unique:
        raise AssertionError("Results inventory must contain 269 unique artifact paths")
