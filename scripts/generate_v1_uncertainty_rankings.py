"""Propagate v1 black-hole mass uncertainty through growth diagnostics.

The v1 uncertainty model samples source-reported asymmetric log(MBH) errors
...
from scripts.generate_v1_rankings import build_ranking_table, read_inputs
from src.models import required_fedd_for_seed, required_seed_mass_for_growth

RESULTS_DIR = REPO_ROOT / "results"
FEDD_SUMMARY_PATH = RESULTS_DIR / "v1_uncertainty_required_fedd_summary.csv"
MSEED_SUMMARY_PATH = RESULTS_DIR / "v1_uncertainty_required_mseed_summary.csv"
