...
As of the 2026-08-27 repository-layout maintenance pass, generated artifacts
...
The UHZ1 extension is independently covered by
`releases/v7.3-catalogue-manifest.json` and
...
`data/crossmatch/v3/v3_measurement_object_links.csv` rather than encoded by deleting
either measurement.
