...
| `results/releases/v2/tables/v2_uncertainty_aware_ranking_table.csv` | one row per frozen v1 measurement/object | Point-estimate ranking table plus uncertainty percentiles, threshold probabilities, and uncertainty-aware ranks. |
