# Legacy Catalogue-Expansion Candidate Memo

> Historical planning note. This memo predates the implemented project-release
> chronology and is retained for provenance. Current sequencing lives in
> `.codex_tmp/catalogue-expansion-guide.md`; completed Taylor work is v3, not v2.
...
These were candidate rows because they contain direct or
...
| `taylor24_ceers_rubies_blagn` | Taylor et al. 2024/2025, "Broad-Line AGN at 3.5<z<6", arXiv:2409.06772 | 63 measurements of 62 CEERS/RUBIES BLAGN at 3.5 < z < 6.8 | Implemented in v3; large JWST broad-line sample with an explicit duplicate-observation link. | z, MBH, line properties, LRD flag |
