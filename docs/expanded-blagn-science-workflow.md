# Expanded BLAGN Science Workflow
...
The first command rebuilds the separate expanded measurement and physical-object
catalogues. The second writes only files beginning with `expanded_blagn_` in
...
| --- | --- | --- |
| Point evaluation | `expanded_blagn_measurement_evaluation.csv` | `expanded_blagn_physical_object_evaluation.csv` |
| Point ranking | `expanded_blagn_measurement_point_ranking.csv` | `expanded_blagn_physical_object_point_ranking.csv` |
| Uncertainty required fEdd | `expanded_blagn_measurement_uncertainty_fedd.csv` | `expanded_blagn_physical_object_uncertainty_fedd.csv` |
| Uncertainty required seed | `expanded_blagn_measurement_uncertainty_mseed.csv` | `expanded_blagn_physical_object_uncertainty_mseed.csv` |
| Uncertainty ranking | `expanded_blagn_measurement_uncertainty_ranking.csv` | `expanded_blagn_physical_object_uncertainty_ranking.csv` |

Two long-form descriptive summaries are also written:

- `expanded_blagn_catalogue_summary.csv`
- `expanded_blagn_growth_summary.csv`
...
per object using `data/crossmatch/measurement_object_links.csv`.
