...
A separate comprehensive companion at
\repo{results/v3/figures/v3\_all\_object\_growth\_tracks\_full\_assumptions.png}
preserves the historical v1 grid: three seed masses crossed with three
...
\repo{results/<version>/gallery/fedd\_mass\_maps/} and
\repo{results/<version>/gallery/seedredshift\_mass\_maps/}.
