...
{uncertainty-filtered counterpart} keeps those curves but excludes the seven luminous quasars with a maximum
reported black-hole-mass uncertainty above 0.5 dex. The reproducible selection
is stored in the
