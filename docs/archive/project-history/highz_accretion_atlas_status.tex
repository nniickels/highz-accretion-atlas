...
72 reference curves in total. Seed mass uses line style, $f_{\rm Edd}$ uses
color, efficiency uses line width, and merger boost uses opacity. It is an
assumption comparison rather than a fit.
An
