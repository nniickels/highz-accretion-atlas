...
unsupported object remains visible below with its class and redshift.}
\label{fig:tracks}
\end{figure}
...
Each catalogue object receives three canonical visual products: a parameter-map
sheet, a growth-track panel, and a seed-redshift panel. The parameter sheet compares six spin/merger
...
\begin{figure}[H]
\centering
\includegraphics[width=0.98\textwidth]{../../../results/v3/gallery/per_object/broad_line_agn/parameter_maps/v3_parameter_map_hza-gn-38509.png}
...
\textbf{Where to browse.} The per-object products are under
\repo{results/<version>/gallery/per\_object/}.
Catalogue-wide galleries are in \repo{results/<version>/figures/}. The visual
coverage CSV in the version's table directory links every object to all three files
...
\begin{enumerate}[leftmargin=1.5em,itemsep=3pt]
  ...
  \item \repo{results/v3/gallery/per\_object/}: the full visual supplement.
...
tables, an exact result inventory, three visual panels per object, and
