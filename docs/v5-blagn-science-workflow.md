...
The science command writes 16 `results/past_releases/v5/tables/v5_blagn_*.csv` files: measurement- and
...
`results/past_releases/v5/figures/main_text/` and are mapped in
