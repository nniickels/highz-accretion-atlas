...
| Overview growth-track object colors encode broad-line AGN in purple and luminous quasars in yellow; full-assumption companions use blue/orange numerical points and blue/orange/gray no-mass groups | focused palette regression and generated figures | verified |
