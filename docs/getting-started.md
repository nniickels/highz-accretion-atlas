...
## Frozen v6 Science Release

The frozen v6 release extends frozen v5 with the complete seven-row Davis/THRILS
...
figures remain the deliberate rendered set associated with the v5/v6 BLAGN
stage; the current paper-facing figures are the separate v7.5 set.
...
scoring semantics, the v2 ranking-table contract, frozen v1 numeric regression
