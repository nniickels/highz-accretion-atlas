# Shen et al. GNIRS-50 extraction and admission notes

The v3 catalogue admits the complete 50-object Gemini/GNIRS sample from
...
`python -m src.internal.extract_shen19_cds_tables` verifies both CDS hashes, parses the
...
The 1,106-row canonical v3 observable table contains 477 previously assembled rows
