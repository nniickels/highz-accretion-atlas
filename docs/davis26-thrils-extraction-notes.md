...
The v6 source gate used Davis et al., *Extreme Emission Line Galaxies in CEERS
...
not in v6. A coordinate/redshift search found no v5 identity candidate for any
...
including a duplicated THRILS ID in one list. v6 therefore records a source
