...
The present test suite contains 25 passing checks. These protect implementation behavior and current numerical anchors; they do not establish that the astrophysical assumptions are uniquely correct.

\section{Limitations}

The present atlas is a pilot, and its conclusions should be read within seven boundaries:
...
\begin{itemize}
  ...
  \item the GN-11836 source-table Eddington-ratio inconsistency must be clarified before that ratio is used quantitatively; and\par
