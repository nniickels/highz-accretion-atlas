...
7. Apply the multi-class eligibility/mass-comparability contract, then begin v7
   ...
   **Completed 2026-08-25: the audit, generic gate, authoritative Ren Tables
   1--2 extraction, and catalogue-only combined assembly are complete. The
   class-aware science workflow remains separate.**
